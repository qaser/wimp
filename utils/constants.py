...
GIGACHAT_ACTIVATE_MSG = ('Напиши четверостишие коллеге по работе. Мы работаем '
                         'на газотранспортной станции. Без нежностей, добавь '
                         'немного сарказма. Будь креативней. В тексте должны '
                         'быть проявлены уважение и гордость за будущие заслуги. '
                         'В тексте не должно быть слов "газ", "труба", "клад", "звезда". '
                         'Стих должен быть таким, как-будто его сочинил ')
...
COMMENTS_POST = [
    ...
    'Актуальная тема, хорошая подача',
    'Свежий взгляд, оригинальные мысли',
    'Логично, аргументированно',
    'Захватывающе, увлекательно',
    'Глубоко, содержательно',
    'Полезно, информативно',
    'Профессионально, грамотно',
    'Вдохновляюще, мотивирующе',
...
COMMENTS_FEED = [
    ...
    'Занимательно',
    'Актуальная тема',
    'Полезная и содержательная новость',
